...
function App(opts) {
     ...
     * @param {function(function(*, ?Error=), ...*)} declarationFunction
     */
     ...
     * @api
     * @param {string[]} dependencies
     * @param {function(Array<*>)} successCallbackFunction
     ...
     * @api
     * @param {(string|string[]|Object|Function)} pkg - package name, or list of,
     *   or package object, or package function
     * @returns {PYM} this
     */
    this.usePackage = function usePackage(pkg, options) {
        options = options || {};

        var resolvedPackage = _resolvePackageSync(path, pkg);
